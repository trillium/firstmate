...
- `BEADS_SYNC: <step> skipped: the <n>s sync budget was spent` - an earlier step of this same sweep consumed the whole sweep's share of the session-start network budget, so the named step never ran.
