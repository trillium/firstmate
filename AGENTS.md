...
state/               volatile runtime signals; gitignored
  ...
  <id>.parlay-listen-pid    background `parlay listen` pid from a best-effort Parlay chat-panel enrollment at spawn (bin/fm-spawn.sh header); absent for test-mode spawns (`FM_SPAWN_NO_GUARD=1`); killed and removed by teardown
