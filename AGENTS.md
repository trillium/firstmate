...
- `stale-branch-repair` - load before briefing a rebase or conflict-resolution task, and before accepting a crewmate report that a conflicting branch is fixed.
