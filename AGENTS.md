...
state/               volatile runtime signals; gitignored
  ...
  .beads-label-migration-v1  marker recording that bootstrap's one-shot legacy beads task-label migration completed for this home (`docs/configuration.md` "Backlog backend"); safe to delete (forces one idempotent re-sweep)
