...
# It retains the presented wake, buffered-escalation, wedge-marker, and
...
return_reconcile() {
  local evidence blockers drain_err drained wake_ack_line wake_ack_through wake_ack_generation staleness wedge escalations lifecycle_ok=1
