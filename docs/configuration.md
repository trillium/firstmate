...
FM_REMOTE_JOB_BOOTSTRAP_SETTLE_TRIES=50   # fm-remote-doctor.sh and fm-remote-job-lib.sh: settle polls when waiting for a gui domain to drain a bootout before retrying bootstrap
FM_REMOTE_JOB_BOOTSTRAP_TRIES=10   # fm-remote-doctor.sh and fm-remote-job-lib.sh: bootstrap retry attempts for transient EIO errors
FM_REMOTE_JOB_BOOTSTRAP_DELAY=0.5   # fm-remote-doctor.sh and fm-remote-job-lib.sh: seconds between bootstrap retry attempts
